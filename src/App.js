      ...
      >
        ...
        <ResponsiveWrapper flex={6} fd={"column"} style={{
          ...
          >
            ...
            >
              TWO WAYS TO MINT <br />
              <span style={{ fontSize: "27px" }}>{data.totalSupply || 2141 } / {CONFIG.MAX_SUPPLY}</span>
            </s.TextTitle>
            <s.TextDescription
              style={{
                textAlign: "center",
        ...
        <div id="mobileWarning" style={{ display: "none", position: "fixed", width: "100vw", height: "100%", background: "#201B58", top: "0", left: "0", zIndex: "1", padding: "30px 20px", overflowY: "auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            ...
            <span style={{ fontSize: "27px", color: "rgb(45, 236, 182)", fontWeight: "700" }}>{data.totalSupply || "2141"} / {CONFIG.MAX_SUPPLY}</span>
          </div>
          <div>
